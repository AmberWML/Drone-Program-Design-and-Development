...
******************************************************************************/
/**
* @brief This class has collection of static methods that help with manipulating picojson things.
*/
class JsonHelper {
 public:
  ...
  /**
  * @brief Extract a string from a picojson object at the provided key string.
  */
  ...
  /**
  * @brief Extract a double from a picojson object at the provided key string.
  */
  ...
  /**
  * @brief Print every key in a picojson object and its associated value.
  */
  ...
  /**
  * @brief Print the details of a picojson object that can be used to create entities.
  */
